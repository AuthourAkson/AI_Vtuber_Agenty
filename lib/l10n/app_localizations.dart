...
class AppLocalizations {
  ...
  static const _strings = <String, Map<String, String>>{
    ...
    'streamTitle':          {'en': 'Stream & YouTube Chat',   'zh': '直播 & YouTube 聊天'},
    'streamId':             {'en': 'YouTube Stream ID',       'zh': 'YouTube 直播 ID'},
    'streamIdHint':         {'en': 'Enter YouTube live stream ID or URL', 'zh': '输入 YouTube 直播 ID 或 URL'},
    'streamConnect':        {'en': 'Connect to Live Chat',    'zh': '连接到直播聊天'},
    'streamMessages':       {'en': 'Live Chat Messages',      'zh': '直播聊天消息'},
    'streamNotConnected':   {'en': 'Not connected to stream', 'zh': '未连接到直播'},
    'streamSetlist':        {'en': 'Setlist (Karaoke/DJ Mode)','zh': '歌单（卡拉OK/DJ 模式）'},
    'streamNoItems':        {'en': 'No items in setlist',     'zh': '歌单中无曲目'},
