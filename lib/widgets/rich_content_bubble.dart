          ...
          return Padding(
            ...
            child: Math.tex(
              ...
              textStyle: TextStyle(
                ...
                color: isUser
                    ? ShadColors.secondaryForeground.withAlpha(204)
  ...
  Widget _md(String text) {
    ...
    return MarkdownBody(
      ...
      styleSheet: MarkdownStyleSheet(
        ...
        h1: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: ShadColors.foreground),
        h2: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: ShadColors.foreground),
        blockquoteDecoration: const BoxDecoration(
          border: Border(left: BorderSide(color: ShadColors.ring, width: 2)),
        ),
        blockquotePadding: const EdgeInsets.only(left: 10),
        listBullet: const TextStyle(color: ShadColors.mutedForeground),
      ),
    );
  }
