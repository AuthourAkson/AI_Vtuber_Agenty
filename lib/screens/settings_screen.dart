...
OutlinedButton.icon(
onPressed: () {},
icon: Icon(Icons.delete_outline, size: 18, color: const Color(ThemePreset.destructive)),
label: Text('Clear Local Cache', style: TextStyle(color: const Color(ThemePreset.destructive))),
),
],
),
);
...
size: 16,
color: wa.connected ? ShadTheme.of(context).primary : const Color(ThemePreset.destructive),
),
SizedBox(width: 6),
Expanded(
child: Text(
...
style: TextStyle(
color: wa.connected ? ShadTheme.of(context).primary : ShadTheme.of(context).mutedForeground,
fontSize: 13,
),
),
),
