...
color: _showSettings ? Theme.of(context).colorScheme.primary : ShadTheme.of(context).mutedForeground),
),
),
...
color: active ? Theme.of(context).colorScheme.primary : ShadTheme.of(context).mutedForeground),
),
),
);
}
...
child: Row(
children: [
Icon(icon, size: 16, color: active ? Theme.of(context).colorScheme.primary : ShadTheme.of(context).mutedForeground),
const SizedBox(width: 8),
Text(title, style: TextStyle(fontSize: 13,
color: active ? Theme.of(context).colorScheme.primary : ShadTheme.of(context).foreground)),
],
),
),
);
...
const SizedBox(height: 4),
701|              const Text('Create named profiles with base URL, API key, and model. Select a profile when starting an agent chat.',
style: TextStyle(fontSize: 13, color: ShadTheme.of(context).mutedForeground)),
],
),
),
