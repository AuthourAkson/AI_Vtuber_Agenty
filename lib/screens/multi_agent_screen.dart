...
class _MultiAgentScreenState extends State<MultiAgentScreen> {
    ...
    return Consumer<AgentManager>(
      builder: (context, mgr, _) {
        return Row(
          children: [
            // ── Secondary Sidebar ──
            SizedBox(width: 260, child: _buildSecondarySidebar(mgr)),
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _showSettings
                    ? ShadTheme.of(context).sidebarAccent
                    : Colors.transparent,
        ...
        : mgr.agentSummaries
              .where(
                (a) =>
                    ...
                    a.uuid.toLowerCase().contains(_searchQuery),
              )
              .toList();
      ...
      children: [
        ...
        if (filtered.isEmpty)
          Padding(
            ...
            child: Text(
              AppLocalizations.of(context).waNoMatching,
              style: TextStyle(
                fontSize: 12,
                color: ShadTheme.of(context).mutedForeground,
              ),
            ...
            children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          color: isActive
                              ? ShadTheme.of(
                                  context,
                                ).sidebarAccentForeground.withAlpha(180)
                              : ShadTheme.of(context).mutedForeground,
                        ),
                      ),
                  ],
              ...
              if (agent.status == 'unread')
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: ShadTheme.of(context).destructive,
                    borderRadius: BorderRadius.circular(8),
                  ),
                  child: Text(
                    'NEW',
                ...
                child: Container(
                  ...
                  child: Icon(
                    ...
                    color: isActive
                        ? ShadTheme.of(
                            context,
                          ).sidebarAccentForeground.withAlpha(150)
                        : ShadTheme.of(context).mutedForeground,
                  ),
                ),
              ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 12),
              Text(
                AppLocalizations.of(context).waNoEmployees,
                style: TextStyle(
                  fontSize: 14,
                  color: ShadTheme.of(context).mutedForeground,
                ),
              ...
              SizedBox(height: 4),
              Text(
                AppLocalizations.of(context).waEmptyHint,
                style: TextStyle(
                  fontSize: 12,
                  color: ShadTheme.of(context).mutedForeground,
                ),
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      mgr.getPersona(emp.uuid)?.avatarType !=
                          AgentAvatarType.none
                      ? const Color(0xFF22C55E).withAlpha(35)
                      : Theme.of(context).colorScheme.primary.withAlpha(40),
                  borderRadius: BorderRadius.circular(8),
                ),
                child: Icon(
                  mgr.getPersona(emp.uuid)?.avatarType == AgentAvatarType.none
                      ? Icons.person
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    if (mgr.getPersona(emp.uuid) != null) ...[
                      const SizedBox(height: 2),
                      Text(
                        '${mgr.getPersona(emp.uuid)!.voice} · ${mgr.getPersona(emp.uuid)!.avatarType.name}',
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
                          fontSize: 10,
              ...
              // Edit persona (face + voice)
              GestureDetector(
                onTap: () => _showPersonaDialog(mgr, emp),
                child: Padding(
  ...
  void _confirmDelete(AgentModel emp, AgentManager mgr) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(
          AppLocalizations.of(context).waDeleteEmployee,
          style: TextStyle(color: ShadTheme.of(context).foreground),
        ),
        content: Text(
          AppLocalizations.of(context).waDeleteConfirm,
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text(
              ...
              style: TextStyle(color: ShadTheme.of(context).destructive),
            ),
          ),
        ],
      ),
  ...
  void _confirmDeleteSession(AgentModel agent, AgentManager mgr) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: ShadTheme.of(context).card,
        title: Text(
          AppLocalizations.of(context).waDeleteSession,
          style: TextStyle(color: ShadTheme.of(context).foreground),
        ),
        content: Text(
          AppLocalizations.of(context).waDeleteSessionConfirm,
          style: TextStyle(color: ShadTheme.of(context).mutedForeground),
        ),
        actions: [
          TextButton(
    ...
    return Container(
      ...
      child: SizedBox(
        ...
        child: OutlinedButton.icon(
          onPressed: () =>
              isSkills ? _showAddSkillDialog() : _showCreateEmployeeDialog(),
          icon: Icon(Icons.add, size: 18),
          label: Text(
            isSkills
                ? AppLocalizations.of(context).skillAdd
                : AppLocalizations.of(context).waCreateEmployee,
          ),
  ...
  // ══════════════════════════════════════════════════════════
  // Employee Persona Editor (Direction 1: face + voice + personality)
  // ══════════════════════════════════════════════════════════

  void _showPersonaDialog(AgentManager mgr, AgentModel emp) {
    final existing = mgr.getPersona(emp.uuid);
    final l2dService = Live2DModelService();
    final vrmService = VrmModelService();
    final live2dModels = l2dService.listModels();
    final vrmModels = vrmService.listModels();

    var avatarType = existing?.avatarType ?? AgentAvatarType.none;
    var avatarPath = existing?.avatarPath ?? '';
    var voice = existing?.voice ?? 'zh-CN-XiaoxiaoNeural';
    var systemPrompt = existing?.systemPrompt ?? '';
    var voiceEnabled = existing?.voiceEnabled ?? true;
    ...
    if (!commonVoices.contains(voice)) commonVoices.insert(0, voice);

    Widget modelPicker() {
      final models = avatarType == AgentAvatarType.live2d
          ? live2dModels
          : vrmModels;
      if (models.isEmpty) {
        return Text(
          avatarType == AgentAvatarType.live2d
              ? '还没有 Live2D 模型（D:\\AiVtuber_Agent_profile\\models\\live2d）'
              : '还没有 VRM 模型（D:\\AiVtuber_Agent_profile\\models\\vrm）',
          style: TextStyle(
            fontSize: 10,
            color: ShadTheme.of(context).mutedForeground,
          ),
      ...
      // Pre-select the first model if current path is empty/invalid
      if (avatarPath.isEmpty || !models.any((m) => m['path'] == avatarPath)) {
        avatarPath = models.first['path'] ?? '';
      }
      return DropdownButtonFormField<String>(
        key: ValueKey('persona-model-$avatarType-${models.length}'),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        width: 420,
                        child: DropdownButtonFormField<AgentAvatarType>(
                          initialValue: avatarType,
                          isDense: true,
                          dropdownColor: ShadTheme.of(context).card,
                          decoration: InputDecoration(
                            filled: true,
                          ...
                          onChanged: (v) {
                            setDialogState(() {
                              avatarType = v ?? AgentAvatarType.none;
                              avatarPath = '';
                            });
                          },
                        ),
                      ...
                      if (avatarType != AgentAvatarType.none) ...[
                        SizedBox(width: 420, child: modelPicker()),
                        const SizedBox(height: 10),
                      ],
                      SizedBox(
                        width: 420,
                        child: DropdownButtonFormField<String>(
                          ...
                          items: commonVoices
                              ...
                              .toList(),
                          onChanged: (v) {
                            if (v != null) setDialogState(() => voice = v);
                          },
                        ),
                      ),
                      const SizedBox(height: 10),
                      SizedBox(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: '例如：你是WenzAgent公司的资深代码审核工程师，说话简洁专业。',
                            labelStyle: TextStyle(
                              fontSize: 11,
                              color: ShadTheme.of(context).mutedForeground,
                            ),
                ...
                TextButton(
                  onPressed: () {
                    final persona = AgentPersona(
                      avatarType: avatarType,
                      avatarPath: avatarType == AgentAvatarType.none
                          ? ''
                          : avatarPath,
                      voice: voice,
  ...
  Widget _buildSettingsContent(AgentManager mgr) {
    switch (_activeSettingSection) {
      ...
      default:
        return Center(
          child: Text(
            '$_activeSettingSection — coming soon',
            style: TextStyle(color: ShadTheme.of(context).mutedForeground),
          ),
        );
    }
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                AppLocalizations.of(context).aiSubtitle,
                style: TextStyle(
                  fontSize: 13,
                  color: ShadTheme.of(context).mutedForeground,
                ),
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (_, i) =>
                _profileCard(mgr.providerProfiles[i], i, mgr),
          ),
        ),
        // Add profile button
        Container(
          ...
          decoration: BoxDecoration(
            border: Border(
              top: BorderSide(color: ShadTheme.of(context).border),
            ),
          ),
          child: SizedBox(
            width: double.infinity,
        ...
        children: [
          Row(
            children: [
              ...
              GestureDetector(
                onTap: () =>
                    _showProfileDialog(mgr, index: index, existing: profile),
                child: Icon(
                  Icons.edit,
                  size: 16,
                  color: ShadTheme.of(context).mutedForeground,
          ...
          _profileRow(
            ...
            profile.apiKey.isNotEmpty
                ? '${profile.apiKey.substring(0, profile.apiKey.length > 12 ? 12 : profile.apiKey.length)}...'
                : '(not set)',
          ),
        ],
      ),
  ...
  void _showProfileDialog(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: ShadTheme.of(context).card,
        title: Text(
          existing != null ? 'Edit Profile' : 'New Profile',
          style: TextStyle(color: ShadTheme.of(context).foreground),
        ),
        content: SizedBox(
          width: 400,
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  running ? l10n.mcpRunning : l10n.mcpStopped,
                  style: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w600,
                    color: color,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 24),
          ...AgentManager.builtinPermDefs.map(
            (def) => _permToggleCard(mgr, def, l10n),
          ),
        ],
      ),
    );
  ...
  String _permItemLabelByKey(String key, AppLocalizations l10n) {
    switch (key) {
      case 'permFileRead':
        return l10n.permFileRead;
      case 'permFileWrite':
        return l10n.permFileWrite;
      case 'permFileDelete':
        return l10n.permFileDelete;
      case 'permFilePatch':
        return l10n.permFilePatch;
      case 'permDirCreate':
        return l10n.permDirCreate;
      case 'permCmdExec':
        return l10n.permCmdExec;
      case 'permBgCmd':
        return l10n.permBgCmd;
      case 'permGitOps':
        return l10n.permGitOps;
      case 'permDocRead':
        return l10n.permDocRead;
      case 'permDocWrite':
        return l10n.permDocWrite;
      case 'permTaskRead':
        return l10n.permTaskRead;
      case 'permTaskWrite':
        return l10n.permTaskWrite;
      default:
        return key;
    }
  }
  ...
  String _permItemDescByKey(String key, AppLocalizations l10n) {
    switch (key) {
      case 'permFileReadDesc':
        return l10n.permFileReadDesc;
      case 'permFileWriteDesc':
        return l10n.permFileWriteDesc;
      case 'permFileDeleteDesc':
        return l10n.permFileDeleteDesc;
      case 'permFilePatchDesc':
        return l10n.permFilePatchDesc;
      case 'permDirCreateDesc':
        return l10n.permDirCreateDesc;
      case 'permCmdExecDesc':
        return l10n.permCmdExecDesc;
      case 'permBgCmdDesc':
        return l10n.permBgCmdDesc;
      case 'permGitOpsDesc':
        return l10n.permGitOpsDesc;
      case 'permDocReadDesc':
        return l10n.permDocReadDesc;
      case 'permDocWriteDesc':
        return l10n.permDocWriteDesc;
      case 'permTaskReadDesc':
        return l10n.permTaskReadDesc;
      case 'permTaskWriteDesc':
        return l10n.permTaskWriteDesc;
      default:
        return key;
    }
  }
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    value: totalSize > 0
                        ? (totalSize / (500 * 1024 * 1024)).clamp(0.0, 1.0)
                        : 0.05,
        ...
        child: Column(
          children: [
            Icon(
              ...
              size: 36,
              color: ShadTheme.of(context).mutedForeground.withAlpha(80),
            ),
            SizedBox(height: 8),
            Text(
              message,
            ...
            children: [
              ...
              Container(
                ...
                child: SwitchListTile(
                  ...
                  onChanged: (v) =>
                      ap.update(ap.prefs.copyWith(autoOpenLastPage: v)),
                  activeColor: ShadTheme.of(context).primary,
                ),
              ),
              SizedBox(height: 16),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                            color: ShadTheme.of(context).input,
                          ),
                        ),
                        contentPadding: EdgeInsets.symmetric(
                          horizontal: 12,
                      ...
                      onChanged: (v) {
                        if (v != null)
                          ap.update(ap.prefs.copyWith(language: v));
                      },
                    ),
                  ],
                ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            mgr.connected
                ? 'Connected to ${mgr.host}:${mgr.port}'
                : 'Not connected',
            style: TextStyle(
              fontSize: 13,
              color: mgr.connected
          ...
          if (_lanTab == 0) ...[
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () => mgr.joinLAN(
                  host: _waHostCtrl.text,
                  port: int.tryParse(_waPortCtrl.text) ?? 9090,
                ),
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 4),
              Text(
                '${devices.length} ${AppLocalizations.of(context).devicesOnline}',
                style: TextStyle(
                  fontSize: 13,
                  color: ShadTheme.of(context).mutedForeground,
                ),
        ...
        Expanded(
          child: devices.isEmpty
              ? Center(
                  child: Text(
                    AppLocalizations.of(context).noDevicesOnline,
                    style: TextStyle(
                      color: ShadTheme.of(context).mutedForeground,
                    ),
                  ),
  ...
  Widget _deviceDetailCard(LanDeviceInfo device, AgentManager mgr) {
    ...
    final typeLabel = (device.type == 'mobile')
        ? AppLocalizations.of(context).deviceTypeMobile
        : AppLocalizations.of(context).deviceTypeDesktop;
    final osLabel = device.os ?? AppLocalizations.of(context).notSet;
    final ipLabel = device.ip ?? AppLocalizations.of(context).notSet;
    final deviceIdLabel =
        device.deviceId ?? AppLocalizations.of(context).notSet;
          ...
          child: Column(
            ...
            children: [
              ...
              if (isExpanded) ...[
                ...
                // Detail rows
                _detailRow(
                  AppLocalizations.of(context).deviceTypeLabel,
                  typeLabel,
                ),
                _detailRow(
                  AppLocalizations.of(context).devicePlatform,
                  device.platform ?? AppLocalizations.of(context).notSet,
                ),
                _detailRow(AppLocalizations.of(context).deviceOs, osLabel),
                _detailRow(AppLocalizations.of(context).deviceIp, ipLabel),
                _detailRow(
                  AppLocalizations.of(context).deviceConnectedAt,
                  connectedTime,
                ),
                _detailRow(
              ...
              Row(
                children: [
                  ...
                  _logActionBtn(
                    l10n.logExport,
                    Icons.download,
                    () => _exportLogs(l10n, logService),
                  ),
                  SizedBox(width: 6),
                  _logActionBtn(
                    l10n.logClear,
                    Icons.delete_outline,
                    () => _confirmClearLogs(l10n, logService),
                  ),
                ],
              ),
              // ── Filter chips ──
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...
                    ...LogLevel.values.map(
                      (lvl) => _logFilterChip(lvl.label, lvl),
                    ),
                  ],
                ),
              ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (backend == SyncBackend.webdav) ...[
                  ...
                  _syncTextField(
                    l10n.syncUsername,
                    _syncService.config.webdavUsername,
                    hint: 'your@email.com',
                    onChanged: (v) {
                  ...
                  _syncTextField(
                    l10n.syncPassword,
                    _syncService.config.webdavPassword,
                    hint: '••••••••',
                    obscure: true,
                    onChanged: (v) {
                              ...
                              if (mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      result.success
                                          ? l10n.syncTestSuccess
                                          : '${l10n.syncTestFailed}: ${result.message}',
                                    ),
                                    backgroundColor: ShadTheme.of(context).card,
                                  ),
                                );
                ...
                if (backend == SyncBackend.localFolder) ...[
                  ...
                  _syncTextField(
                    l10n.syncLocalFolder,
                    _syncService.config.localFolderPath,
                    hint: r'D:\AiVtuber_Agent_profile_backup',
                    onChanged: (v) {
                    ...
                    children: [
                      ...
                      Expanded(
                        child: SliderTheme(
                          ...
                          child: Slider(
                            value: _syncService.config.intervalMinutes
                                .toDouble(),
                            min: 1,
                            max: 60,
                            divisions: 59,
                      ...
                      Container(
                        ...
                        child: Text(
                          '${_syncService.config.intervalMinutes} min',
                          style: TextStyle(
                            fontSize: 13,
                            fontWeight: FontWeight.w600,
                            color: ShadTheme.of(context).primary,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text(
                        _syncStatusText(l10n, status, lastResult),
                        style: TextStyle(
                          fontSize: 13,
                          color: ShadTheme.of(context).mutedForeground,
                        ),
  ...
  Widget _syncBackendOption(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected
              ? ShadTheme.of(context).primary.withAlpha(15)
              : ShadTheme.of(context).secondary,
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
            color: selected
                ? ShadTheme.of(context).primary
                : ShadTheme.of(context).border,
      ...
      case SyncStatus.syncing:
        return SizedBox(
          ...
          child: CircularProgressIndicator(
            strokeWidth: 2,
            valueColor: AlwaysStoppedAnimation(ShadTheme.of(context).primary),
          ),
        );
  ...
  Future<void> _checkForUpdate(AgentManager mgr) async {
    ...
    const repoApi =
        'https://api.github.com/repos/AuthourAkson/AI_Vtuber_Agenty/releases/latest';
  ...
  Widget _logFilterChip(String label, LogLevel? level) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: active
              ? _logLevelColor(level).withAlpha(30)
              : ShadTheme.of(context).secondary,
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: active
  ...
  Widget _logEntryTile(LogEntry entry, AppLocalizations l10n) {
    ...
    return Column(
      children: [
        GestureDetector(
          onTap: () =>
              setState(() => _expandedLogId = isExpanded ? null : entry.id),
          child: Container(
            padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
            color: isExpanded
                ? ShadTheme.of(context).secondary.withAlpha(80)
                : null,
            child: Row(
              children: [
                // Level dot
      ...
      child: Column(
        ...
        children: [
          Icon(
            Icons.chat_bubble_outline,
            size: 56,
            color: ShadTheme.of(context).mutedForeground.withAlpha(100),
          ),
          SizedBox(height: 16),
          Text(
            AppLocalizations.of(context).waEmptyHint,
          ...
          SizedBox(height: 6),
          Text(
            AppLocalizations.of(context).waEmptySub,
            style: TextStyle(
              fontSize: 12,
              color: ShadTheme.of(context).mutedForeground,
            ),
    ...
    if (employees.isEmpty) {
      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: Text(
            'Create an AI employee first in the Contacts tab.',
            style: TextStyle(color: ShadTheme.of(context).mutedForeground),
          ),
          actions: [
            TextButton(
          ...
          child: Row(
            children: [
              ...
              Container(
                ...
                child: Text(
                  mgr.activeAgentStatus.toUpperCase(),
                  style: TextStyle(
                    fontSize: 10,
                    fontWeight: FontWeight.w600,
                    color: statusColor,
        ...
        Expanded(
          child: mgr.activeMessages.isEmpty
              ...
              : Builder(
                  builder: (context) {
                    final totalItems =
                        mgr.activeMessages.length +
                        (mgr.activeAgentStatus == 'processing' ||
                                mgr.activeAgentStatus == 'streaming'
                            ? 1
                            : 0);
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                if (hasToolResult) _buildToolResultSection(toolResult!),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(width: 4),
                Text(
                  hasResult ? 'TOOL RESULT: $name' : 'TOOL CALL: $name',
                  style: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w600,
                    color: Theme.of(context).colorScheme.primary,
            ...
            builder: (context, _) {
              ...
              return Container(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: theme.border?.withAlpha(80) ?? Color(0xFFECECEC),
                  ),
                  boxShadow: [
                    BoxShadow(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: hasText
              ? primary
              : (theme.mutedForeground?.withAlpha(40) ?? Color(0xFFE0E0E0)),
          borderRadius: BorderRadius.circular(999),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                color: hasText
                    ? onPrimary
                    : (theme.mutedForeground ?? Color(0xFF999999)),
              ),
            ),
            SizedBox(width: 5),
            Icon(
  ...
  void _showProfilePicker(dynamic agent, AgentManager mgr) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        backgroundColor: ShadTheme.of(context).card,
        title: Text(
          AppLocalizations.of(context).waSelectProfile,
          style: TextStyle(
            color: ShadTheme.of(context).foreground,
            fontSize: 15,
          ),
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                      ...
                      maxLines: 2,
                      decoration: InputDecoration(
                        labelText: l10n.skillDesc,
                        hintText: l10n.skillDescHint,
                        filled: true,
                        fillColor: ShadTheme.of(context).secondary,
                        border: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(8),
                  ...
                  if (!isMcp) ...[
                      ...
                      children: [
                        ...
                        OutlinedButton(
                          onPressed: () async {
                            ...
                            if (picked != null)
                              setDialogState(() => folderPath = picked);
                          },
                    ...
                    Text(
                      'Uses MCP servers configured in Settings → MCP Config',
                      style: TextStyle(
                        fontSize: 12,
                        color: ShadTheme.of(context).mutedForeground,
                      ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    onChanged: (v) =>
                        setDialogState(() => folderSearchFilter = v),
                  ),
                  SizedBox(height: 8),
                  if (currentPath.isEmpty) // <-- fixed: empty = show drives
                    ...
                    Expanded(
                      child: _buildFolderContents(currentPath, (
                        String newPath,
                      ) {
                        if (newPath == '..') {
  ...
  Widget _buildSkillDetailView(AgentManager mgr) {
    ...
    final typeLabel = skill.skillType == 'folder'
        ? 'Folder'
        : (skill.skillType == 'mcp' ? 'MCP' : 'Config');
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: ShadTheme.of(context).card,
            border: Border(
              bottom: BorderSide(color: ShadTheme.of(context).border),
            ),
          ),
          child: Row(
            children: [
              ...
              IconButton(
                ...
                onPressed: () => _confirmDeleteSkill(mgr, skill),
                tooltip: l10n.skillDelete,
              ),
            ],
          ),
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                _buildDetailSection(l10n.skillInfo, [
                  ...
                  _buildDetailRow(
                    l10n.skillCreatedAt,
                    _formatDateTime(skill.createTime),
                  ),
                  _buildDetailRow(
                    l10n.skillUpdatedAt,
                    _formatDateTime(skill.updateTime),
                  ),
                ]),
                if (skill.description != null &&
                    skill.description!.isNotEmpty) ...[
  ...
  void _confirmDeleteSkill(AgentManager mgr, GlobalSkillEntity skill) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          l10n.skillDeleteConfirm.replaceAll(r'${name}', skill.name),
          style: TextStyle(color: ShadTheme.of(context).foreground),
        ),
        actions: [
          TextButton(
  ...
  Widget _buildEmployeeDetailView(AgentManager mgr) {
    ...
    final addedIds = empSkills
        .map((s) => s.globalSkillId)
        .whereType<String>()
        .toSet();
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16),
                // Avatar Persona (Direction 1)
                _buildDetailSection('员工形象 / Persona', [
                  Builder(
                    builder: (_) {
                      final persona = mgr.getPersona(emp.uuid);
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildDetailRow(
                            '形象类型',
                            persona?.avatarType.name ?? 'none',
                          ),
                          if (persona != null &&
                              persona.avatarType != AgentAvatarType.none)
                            Padding(
                          ...
                          _buildDetailRow(
                            'Voice',
                            persona != null ? persona.voice : '默认',
                          ),
                          _buildDetailRow(
                            '回复说话',
                            persona?.voiceEnabled == false ? 'off' : 'on',
                          ),
                          if (persona != null &&
                          ...
                          SizedBox(height: 8),
                          OutlinedButton.icon(
                            onPressed: () => _showPersonaDialog(mgr, emp),
                            icon: Icon(
                              Icons.face_retouching_natural,
                              size: 15,
                              color: Theme.of(context).colorScheme.primary,
                      ...
                      (es) => Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            GestureDetector(
                              onTap: () => mgr.removeSkillFromEmployee(
                                es.globalSkillId ?? es.uuid,
                              ),
                              child: Icon(
                                Icons.close,
                                size: 16,
  ...
  void _showGlobalSkillPicker(AgentManager mgr, Set<String> addedIds) {
    final l10n = AppLocalizations.of(context);
    final available = mgr.skills
        .where((s) => !addedIds.contains(s.uuid) && s.enabled == 1)
        .toList();
                ...
                : Row(
                    ...
                    children: [
                      Icon(
                        Icons.copy,
                        size: 16,
                        color: _hovering ? fg : fg.withAlpha(80),
                      ),
                      const SizedBox(width: 4),
                      Text(
                        '复制',
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (_expanded)
          Padding(padding: EdgeInsets.only(bottom: 6), child: widget.child),
      ],
    );
  }
}
