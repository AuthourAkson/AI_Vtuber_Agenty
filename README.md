...
> **一个集 Live2D / VRM 角色、Bilibili 直播、多 TTS 语音、WenzAgent 多智能体协作于一体的 Flutter Desktop AI VTuber 应用。**
>
...
| Character | ![Character](image/CharacterPage.png) |
| TTS | ![TTS](image/TTsPage.png) |
| Memory | ![Memory](image/MemoryPage.png) |
| Stream | ![Stream](image/StreamPage.png) |
| Pipeline | ![Pipeline](image/StreamPipelinePage.png) |
| Multi-Agent Chat | ![Agent Chat](image/MultiAgent-EmployeeSession.png) |
| Multi-Agent Settings | ![Agent Settings](image/MultiAgent-Settings.png) |
| Data Sync | ![Data Sync](image/MultiAgent-Settings-DataSync.png) |
...
### 📺 Bilibili Streaming & Viewer Tasks
